  ...
  return (
    <div className="bg-slate-950/15">
      ...
      <div className="bg-slate-300 py-5 border-2 border-t border-slate-400">
        <div className="container mx-auto max-w-screen-lg flex flex-row flex-wrap items-center justify-center gap-4">

          <div className="w-fit rounded-[25px] bg-white px-7 p-6">
