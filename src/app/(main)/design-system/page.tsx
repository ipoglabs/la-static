...
const sections = [
  {
    ...
    items: [
      ...
      { title: "Toggle Button Group", desc: "Multi-select, segmented control", href: "/design-system/toggle-group", icon: "⊞" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Date Input", desc: "Date picker with calendar overlay", href: "/design-system/date-input", icon: "📅" },
      { title: "Phone Number Input", desc: "Country code + number field", href: "/design-system/phone-number-input", icon: "📞" },
      ...
      { title: "Phone OTP", desc: "SMS one-time password flow", href: "/design-system/phone-otp", icon: "🔢" },
