...
export default function DonateReviewPage() {
  ...
  // Scan Pay is only offered for India — if the selected country changes
  // away from India while Scan Pay is active, fall back to Wallet Pay.
  useEffect(() => {
    if (scanCountry !== 'IN' && activeTab === 'sp') {
      setActiveTab('wp')
    }
  }, [scanCountry, activeTab])
