...
export default function DonateReviewPage() {
  ...
  const [activeTab, setActiveTab]       = useState<Tab>(method === 'card' ? 'cc' : 'sp')
            ...
            {activeTab === 'cc' && (
              <div className="flex flex-col gap-0 max-md:px-8">
                ...
                <div className="flex flex-row justify-between items-center border-b border-slate-300 py-8 mb-8">
                  <span className="text-lg font-semibold text-slate-600">Credit Card Payment</span>
                  <div className="text-2xl font-bold text-slate-800">
                    ...
                    {amount} <span className="font-normal text-sm">{currency.toUpperCase()}</span>
                  </div>
                </div>
