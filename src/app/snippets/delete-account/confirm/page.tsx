        ...
        <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
          ...
          {stage === 2 && (
            <div className="px-6 py-7 sm:px-8 space-y-7">
              ...
              <div className="flex items-center gap-3">
                {/* Back → returns to the profile page entry point */}
                <button
                  type="button"
                  onClick={() => router.back()}
          ...
          {stage === 3 && (
            <div className="px-6 py-7 sm:px-8 space-y-7">
              ...
              {/* Summary — plain readable list of selected reasons */}
              <div className="space-y-2.5">
                ...
                {/* Show the actual details text the user typed — plain text, no bullet */}
                {detailsCount > 0 && (
              ...
              {/* Separator before acknowledgement */}
              <hr className="border-slate-400" />

              {/* Acknowledgement checkbox — final delete button stays disabled until ticked */}
              ...
              {/* Soft rescue — shown before the final delete CTA */}
              <div className="flex items-center gap-3">
                <button
                  type="button"
              ...
              {/* Inline error — shown if DELETE /account fails */}
              {error && (
