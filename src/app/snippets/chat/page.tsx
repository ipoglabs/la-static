...
// Placeholder site header — replace with real Header in production
function SiteHeader() {
  return (
    <header className="h-14 shrink-0 flex items-center px-6 border-b border-slate-400 bg-slate-200">
      <span className="text-sm font-semibold text-slate-00 tracking-widest uppercase">Header</span>
    </header>
  );
}

// Placeholder site footer — replace with real Footer in production
function SiteFooter() {
  return (
    <footer className="h-12 shrink-0 flex items-center justify-center border-t border-slate-400 bg-slate-200">
      <span className="text-sm font-semibold text-slate-400 tracking-widest uppercase">Footer</span>
    </footer>
  );
}
