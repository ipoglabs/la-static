...
import { getFeatures, COUNTRY_CONFIGS, type CountryCode } from "@/lib/country-config";
  ...
  return (
    <footer className="bg-slate-800 border-t-4 border-rose-500">
      ...
      <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="flex items-center gap-3">
            <Link className="flex gap-2 items-center shrink-0" href="/">
              ...
              <div className="relative">
                ...
                {countryLabel && (
                  <span className="absolute right-1 -bottom-4 text-sm font-semibold text-white">{countryLabel}</span>
                )}
              </div>
            </Link>
        ...
        <div id="footer-nav" className={cn("grid-cols-2 gap-y-1 pt-2 pb-2", gridColsClass, isOpen ? "grid" : "hidden")}>
          <div className="mb-5">
            ...
            <Link className="my-1 block text-sm text-slate-200 hover:text-white transition-colors" href="#">Tutorials</Link>
            <Link className="my-1 block text-sm text-slate-200 hover:text-white transition-colors" href="#">Frequent Questions</Link>
            <Link className="my-1 block text-sm text-slate-200 hover:text-white transition-colors" href="#">
          ...
          <div className="mb-5">
            ...
            <Link className="my-1 block text-sm text-slate-200 hover:text-white transition-colors" href="#">About lokalads</Link>
            <Link className="my-1 block text-sm text-slate-200 hover:text-white transition-colors" href="#">Why Advertise?</Link>
            <Link className="my-1 block text-sm text-slate-200 hover:text-white transition-colors" href="#">Careers</Link>
            <Link className="my-1 block text-sm text-slate-200 hover:text-white transition-colors" href="#">
      ...
      <div className="flex flex-col items-center pb-3 container mx-auto px-4 max-w-5xl">
        ...
        <hr className="w-96 h-px border-slate-500 mb-2" />
        <div className="flex flex-row flex-wrap items-center justify-center py-1 text-slate-300 text-center">
          <p className="inline-block py-1 text-nowrap text-sm">
          ...
          <LegalDrawer countryCode={countryCode} type="privacy-policy">
            <button type="button" className="py-1 text-sm text-nowrap text-slate-300 hover:text-white transition-colors">Privacy Policy</button>
          </LegalDrawer>
          <svg viewBox="0 0 2 2" width={3} height={3} aria-hidden="true" className="fill-slate-300 mx-2">
            <circle cx="1" cy="1" r="1" />
          </svg>
          <LegalDrawer countryCode={countryCode} type="terms">
            <button type="button" className="py-1 text-sm text-nowrap text-slate-300 hover:text-white transition-colors">Terms &amp; Conditions</button>
          </LegalDrawer>
          <svg viewBox="0 0 2 2" width={3} height={3} aria-hidden="true" className="fill-slate-300 mx-2">
            <circle cx="1" cy="1" r="1" />
          </svg>
          <LegalDrawer countryCode={countryCode} type="cookie-policy">
            <button type="button" className="py-1 text-sm text-nowrap text-slate-300 hover:text-white transition-colors">Cookie Policy</button>
          </LegalDrawer>
          <svg viewBox="0 0 2 2" width={3} height={3} aria-hidden="true" className="fill-slate-300 mx-2">
            <circle cx="1" cy="1" r="1" />
          </svg>
          <button type="button" onClick={() => setFeedbackOpen(true)} className="py-1 text-sm text-nowrap text-teal-300 hover:text-teal-100 transition-colors">Feedback</button>
        </div>
      </div>
      ...
      {features.donationFooter && (
        <div className="bg-white">
          <div className="container mx-auto px-12 py-3 flex flex-col sm:flex-row flex-wrap gap-3 items-center justify-center text-center max-w-5xl">
