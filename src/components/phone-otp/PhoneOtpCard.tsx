            ...
            <div className="space-y-3">
              <div className="flex gap-2">
                <div className="relative shrink-0">
                  <div className="flex items-center h-10 px-3 rounded-md border border-input bg-background text-sm font-medium text-foreground pointer-events-none select-none">
