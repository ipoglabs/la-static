  ...
  return (
    <footer className="bg-slate-800 border-t-4 border-rose-500">
      ...
      <details className="group container mx-auto flex max-sm:flex-col flex-row flex-nowrap gap-2 px-4 py-4 max-w-screen-lg">
        ...
        {/* Summary: Company Info & Toggle Button */}
        ...
        <div className="flex-1 pt-4 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4">
          <div className="flex-1 mb-5">
            ...
            <Link className="my-1 block text-sm text-slate-200" href="#">Tutorials</Link>
            <Link className="my-1 block text-sm text-slate-200" href="#">Frequent Questions (FAQ)</Link>
            <Link className="my-1 block text-sm text-slate-200" href="#">
          ...
          <div className="flex-1 mb-5">
            ...
            <Link className="my-1 block text-sm text-slate-200" href="#">Property</Link>
            <Link className="my-1 block text-sm text-slate-200" href="#">Jobs</Link>
            <Link className="my-1 block text-sm text-slate-200" href="#">
          ...
          <div className="flex-1 mb-5">
            ...
            <Link className="my-1 block text-sm text-slate-200" href="#">London</Link>
            <Link className="my-1 block text-sm text-slate-200" href="#">Bristol</Link>
            <Link className="my-1 block text-sm text-slate-200" href="#">
          ...
          <div className="flex-1 mb-5">
            ...
            <Link className="my-1 block text-sm text-slate-200" href="#">About lokalads</Link>
            <Link className="my-1 block text-sm text-slate-200" href="#">Why to Advertise With Us?</Link>
            <Link className="my-1 block text-sm text-slate-200" href="#">Careers</Link>
            <Link className="my-1 block text-sm text-slate-200" href="#">
      ...
      <div className="relative flex pb-5 px-4 sm:px-12 m-auto text-gray-800 text-sm flex-col max-w-screen-lg items-center">
        ...
        <div className="flex flex-row flex-wrap items-center justify-center p-2 text-slate-300 text-center">
          ...
          <Link className="py-1 text-nowrap" href="#">Privacy Policy</Link>
          <svg viewBox="0 0 2 2" width="3" height="3" aria-hidden="true" className="fill-slate-300 mx-2"><circle cx="1" cy="1" r="1" /></svg>
          <Link className="py-1 text-nowrap" href="#">Conditions</Link>
          <svg viewBox="0 0 2 2" width="3" height="3" aria-hidden="true" className="fill-slate-300 mx-2"><circle cx="1" cy="1" r="1" /></svg>
          <Link className="py-1 text-nowrap" href="#">Cookie Policy</Link>
        </div>
      </div>
