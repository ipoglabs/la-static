...
const TOOLBAR = [
  // Group 1 — inline text
  { key: "bold",                   command: "bold",                icon: Bold,             label: "Bold",          type: "toggle" },
  { key: "italic",                 command: "italic",              icon: Italic,           label: "Italic",        type: "toggle" },
  { key: "underline",              command: "underline",           icon: Underline,        label: "Underline",     type: "toggle" },
  { key: "strikeThrough",          command: "strikeThrough",       icon: Strikethrough,    label: "Strikethrough", type: "toggle" },
  { divider: true },
  // Group 2 — lists
  { key: "insertUnorderedList",    command: "insertUnorderedList", icon: List,             label: "Bullet List",   type: "toggle" },
  { key: "insertOrderedList",      command: "insertOrderedList",   icon: ListOrdered,      label: "Number List",   type: "toggle" },
  { divider: true },
  ...
  { key: "block-blockquote",       command: "formatBlock",         icon: Quote,            label: "Quote",         type: "block",  value: "blockquote" },
] as const;
