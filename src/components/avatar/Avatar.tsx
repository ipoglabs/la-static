...
const sizeMap: Record<AvatarSize, { container: string; text: string; dot: string }> = {
  xs: { container: "h-6 w-6",   text: "text-[10px] font-semibold", dot: "h-2 w-2 ring-[1.5px]"  },
  sm: { container: "h-8 w-8",   text: "text-xs font-semibold",     dot: "h-2.5 w-2.5 ring-2"    },
...
export function Avatar({
  ...
  // Reset error state whenever src changes so a new valid URL is retried.
